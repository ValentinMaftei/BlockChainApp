...
const Ticket = ({ ticket }) => {
    return (
        ...
        <div class="w-full flex flex-col items-center rounded-lg shadow md:flex-row dark:border-dark-blue dark:bg-darkest-blue/[0.5] px-8 py-4 gap-8">
            ...
            <span class="text-3xl font-bold text-gray-900 dark:text-white flex items-center">{parseFloat(ticket.price)}<i class="text-light-purple fi fi-brands-ethereum"></i></span>
            <button type="button" class="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:opacity-[0.8] focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg px-5 py-2.5 text-center">BUY</button>
            </div>
        </div>
