    ...
    return (
        ...
        <div class="w-full flex flex-col items-center rounded-lg shadow md:flex-row dark:border-dark-blue dark:bg-darkest-blue/[0.5] px-8 py-4 gap-8">
            ...
            <div className="flex-col flex h-full gap-2 min-w-fit">
                ...
                <button type="button" onClick={() => { }} class="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:opacity-[0.8] focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg px-5 py-2.5 text-center">BUY</button>
            </div>
        </div>
